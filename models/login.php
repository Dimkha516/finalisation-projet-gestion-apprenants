    ...
    <div class="main">
        ...
        <div class="formulaire">
            ...
            <div class="email">
                ...
                <input type="text" class="email" placeholder="Entrer email adress"> <span class="request" style="right: 5%; top: -40px;">*</span>
            </div>

            <div class="password">
                <label for="pass">Password</label> <span class="request" style="right: 30%;">*</span> <br>
                <input type="password" class="pass" placeholder="Entrer mot de passe"> 
        ...
        <div class="login">
            <a href="http://www.bamba.mbow:8089/architecture/templates/presences.php">
